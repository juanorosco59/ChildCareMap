# ChildCareMap - Grupo 03

### _Mapeo de la inseguridad nutricional infantil en comunidades vulnerables del Perú_

**ChroniCare** es una aplicación web que utiliza **algoritmos avanzados** para analizar y mapear la **inseguridad nutricional infantil** en el Perú. Busca apoyar la **toma de decisiones** en salud y desarrollo social mediante datos y visualizaciones geográficas.
