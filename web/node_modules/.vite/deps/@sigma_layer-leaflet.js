...
// node_modules/@sigma/layer-leaflet/dist/sigma-layer-leaflet.esm.js
...
function syncMapWithSigma(sigma, map) {
  var firstIteration = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false;
  ...
  var bounds = new import_leaflet.LatLngBounds(geoSouthWest, geoNorthEast);
...
function bindLeafletLayer(sigma, opts) {
  ...
  var map = import_leaflet.default.map(mapContainer, _objectSpread2(_objectSpread2({}, (opts === null || opts === void 0 ? void 0 : opts.mapOptions) || {}), {}, {
    zoomControl: false,
    zoomSnap: 0,
    zoom: 0,
  ...
  import_leaflet.default.tileLayer(tileUrl, {
  ...
  function fnSyncMapWithSigma() {
    var firstIteration = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false;
...
export {
  bindLeafletLayer as default,
  graphToLatlng,
  latlngToGraph
};
//# sourceMappingURL=@sigma_layer-leaflet.js.map
