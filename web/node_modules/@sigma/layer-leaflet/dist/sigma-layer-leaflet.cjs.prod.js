...
function syncMapWithSigma(sigma, map) {
  ...
  // Set map BBox
  var bounds = new L.LatLngBounds(geoSouthWest, geoNorthEast);
...
function bindLeafletLayer(sigma, opts) {
  ...
  // Initialize the map
  var map = L__default["default"].map(mapContainer, _objectSpread2(_objectSpread2({}, (opts === null || opts === void 0 ? void 0 : opts.mapOptions) || {}), {}, {
    zoomControl: false,
    zoomSnap: 0,
    zoom: 0,
  ...
  L__default["default"].tileLayer(tileUrl, {
...
exports["default"] = bindLeafletLayer;
